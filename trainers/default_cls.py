            ...
            with torch.no_grad():
                if cfg.project == 'gl':
                    if hasattr(model, 'module'):
                         model.module.project_weight(hyper_net.vector2mask(vector), lmdValue, model.lr)                        
                    else:
                        model.project_weight(hyper_net.vector2mask(vector), lmdValue, model.lr)
                elif cfg.project == 'oto':
                    model.oto(hyper_net.vector2mask(vector))
